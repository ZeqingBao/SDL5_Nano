...
#    Solvent_loc = drug_extaction_solvent_res['A1']
    ...
    Drug_transfer = [33.95, 58.45, 41.65, 5.95, 16.8, 61.25, 41.3, 23.8, 19.95, 54.25, 47.25, 11.2, 2.8, 34.65, 51.1, 47.95]
    SL_1_transfer = [41.65, 23.1, 63.0, 13.65, 68.6, 8.75, 40.95, 20.3, 57.75, 9.8, 32.55, 32.55, 64.05, 22.05, 50.05, 5.95]
    SL_2_transfer = [35.35, 31.5, 9.8, 59.5, 55.3, 22.05, 47.95, 8.4, 69.65, 1.4, 41.3, 24.85, 21.0, 46.2, 20.65, 71.05]
    SL_3_transfer = [21.7, 52.85, 19.6, 48.65, 39.2, 0.0, 50.05, 29.75, 6.3, 39.9, 28.7, 67.9, 76.65, 17.5, 32.2, 16.45]

    LL_1_transfer = [67.55, 31.5, 15.4, 49.35, 39.9, 1.05, 16.45, 54.25, 26.95, 60.2, 42.0, 11.9, 11.55, 34.65, 44.1, 37.45]
    LL_2_transfer = [5.6, 41.3, 77.7, 25.2, 17.85, 49.7, 42.35, 31.85, 21.35, 65.45, 45.15, 0.7, 37.45, 50.4, 31.85, 21.0]
    LL_3_transfer = [6.3, 49.0, 22.05, 40.6, 36.05, 56.7, 7.0, 69.65, 28.35, 47.6, 14.7, 63.7, 1.05, 52.15, 18.9, 58.45]

    P_1_transfer = [24.5, 33.25, 75.25, 14.35, 56.7, 8.75, 25.55, 45.85, 60.55, 0.7, 26.25, 50.75, 25.9, 36.05, 48.65, 18.55]
    P_2_transfer = [59.85, 16.45, 1.75, 42.0, 16.1, 55.65, 49.7, 34.65, 9.8, 47.6, 63.7, 27.65, 73.5, 21.0, 5.6, 60.55]
    P_3_transfer = [53.55, 12.6, 23.1, 50.75, 3.85, 86.1, 28.35, 31.15, 49.0, 22.75, 8.75, 58.8, 36.4, 35.35, 46.55, 12.95]

    S_1_transfer = [259, 529, 101, 343, 46, 300, 371, 169, 249, 344, 400, 19, 262, 110, 215, 398]
    S_2_transfer = [259, 71, 190, 372, 366, 173, 56, 360, 487, 49, 206, 263, 290, 247, 154, 353]
    S_3_transfer = [233, 400, 380, 64, 464, 86, 384, 178, 73, 281, 257, 374, 173, 473, 23, 225]

    Water_transfer = [248, 0, 329, 221, 124, 441, 190, 293, 192, 326, 137, 344, 276, 170, 608, 24]
