...
#    Solvent_loc = drug_extaction_solvent_res['A1']
    ...
    Drug_transfer = [33.6, 58.1, 41.3, 5.6, 16.8, 60.55, 41.65, 23.8, 19.25, 53.9, 47.25, 11.55, 2.45, 34.3, 51.1, 47.95]
    SL_1_transfer = [41.65, 23.8, 62.65, 13.65, 68.6, 9.1, 40.95, 19.95, 57.75, 10.15, 32.9, 32.55, 63.7, 22.05, 50.05, 6.65]
    SL_2_transfer = [34.65, 31.5, 10.85, 59.15, 54.95, 22.4, 48.3, 8.4, 69.3, 1.05, 41.3, 25.2, 21.7, 46.2, 20.3, 70.35]
    SL_3_transfer = [22.05, 52.85, 19.95, 49.0, 38.85, 0.35, 49.7, 30.1, 7.35, 40.25, 29.05, 67.2, 75.95, 17.5, 32.55, 16.45]

    LL_1_transfer = [67.2, 31.5, 15.75, 49.35, 39.55, 1.05, 16.45, 54.25, 27.3, 59.85, 41.65, 12.6, 11.9, 35.0, 43.75, 36.75]
    LL_2_transfer = [5.95, 40.95, 76.65, 24.85, 17.85, 49.7, 42.7, 31.85, 21.0, 65.1, 45.5, 1.4, 37.1, 50.4, 31.85, 20.3]
    LL_3_transfer = [7.0, 49.0, 22.05, 40.95, 36.05, 56.35, 7.0, 69.3, 28.7, 47.6, 14.7, 63.35, 1.05, 51.8, 19.25, 58.45]

    P_1_transfer = [24.5, 32.9, 75.25, 14.35, 56.7, 9.45, 25.55, 45.85, 60.55, 1.4, 26.25, 50.4, 26.6, 36.05, 49.0, 19.25]
    P_2_transfer = [59.5, 16.1, 2.1, 42.35, 16.45, 56.0, 49.35, 34.65, 9.8, 47.95, 63.0, 27.65, 72.8, 21.35, 5.95, 59.85]
    P_3_transfer = [53.55, 12.95, 23.45, 50.75, 4.2, 85.75, 28.35, 31.5, 48.65, 22.75, 9.1, 58.45, 37.1, 35.35, 46.55, 14.0]

    S_1_transfer = [258, 517, 103, 344, 51, 300, 371, 168, 246, 345, 396, 21, 262, 111, 214, 397]
    S_2_transfer = [258, 73, 192, 372, 364, 175, 59, 361, 484, 50, 207, 264, 290, 247, 155, 353]
    S_3_transfer = [235, 408, 374, 66, 463, 86, 380, 176, 77, 283, 256, 370, 174, 470, 31, 224]

    Water_transfer = [249, 2, 331, 219, 122, 439, 190, 295, 193, 323, 141, 345, 274, 171, 600, 26]
