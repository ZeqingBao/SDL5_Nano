...
#    Solvent_loc = drug_extaction_solvent_res['A1']
    ...
    Drug_transfer = [33.6, 58.8, 41.65, 5.95, 16.8, 61.25, 41.65, 24.15, 19.6, 54.25, 47.25, 11.9, 2.8, 35.0, 51.1, 48.65]
    SL_1_transfer = [41.3, 23.8, 63.0, 13.65, 68.6, 8.75, 40.6, 19.6, 57.75, 10.5, 33.25, 32.55, 64.05, 21.7, 50.05, 5.95]
    SL_2_transfer = [34.3, 31.5, 10.5, 59.5, 55.3, 22.05, 48.3, 8.4, 69.3, 1.4, 41.3, 25.55, 22.05, 46.55, 19.95, 70.7]
    SL_3_transfer = [21.7, 52.85, 19.6, 48.65, 38.15, 0.0, 50.05, 29.75, 7.0, 40.6, 28.7, 67.9, 77.35, 17.5, 32.9, 16.1]

    LL_1_transfer = [67.55, 30.8, 16.45, 49.35, 39.9, 1.05, 15.75, 54.25, 26.95, 59.5, 41.3, 11.9, 11.55, 35.0, 44.1, 37.1]
    LL_2_transfer = [5.6, 41.65, 77.0, 24.5, 17.85, 49.7, 42.7, 31.85, 21.0, 64.75, 45.15, 0.7, 37.1, 50.75, 31.85, 19.6]
    LL_3_transfer = [7.0, 49.35, 21.35, 41.3, 36.05, 55.65, 6.65, 69.3, 29.05, 47.6, 14.7, 62.65, 0.0, 51.8, 18.9, 59.15]

    P_1_transfer = [24.5, 32.9, 75.25, 13.65, 56.7, 8.75, 25.9, 45.85, 60.55, 1.4, 26.25, 50.75, 25.9, 36.05, 49.0, 19.6]
    P_2_transfer = [60.55, 15.75, 1.75, 42.7, 16.1, 55.65, 50.05, 34.65, 9.8, 47.6, 63.0, 27.65, 73.5, 21.0, 5.6, 59.15]
    P_3_transfer = [53.55, 12.6, 23.1, 50.75, 4.55, 86.8, 28.7, 31.85, 48.65, 22.4, 9.1, 58.45, 36.4, 35.0, 46.55, 14.0]

    S_1_transfer = [257, 514, 101, 341, 52, 301, 372, 169, 247, 345, 394, 19, 260, 110, 214, 398]
    S_2_transfer = [257, 71, 195, 371, 364, 174, 56, 360, 485, 49, 206, 263, 293, 247, 153, 353]
    S_3_transfer = [237, 414, 371, 65, 461, 82, 381, 173, 77, 283, 257, 370, 172, 473, 31, 225]

    Water_transfer = [249, 0, 333, 224, 123, 443, 190, 298, 191, 323, 143, 347, 274, 170, 603, 24]
